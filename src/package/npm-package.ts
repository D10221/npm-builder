...
/**
 * from: http://json.schemastore.org/package
 * with: https://bcherny.github.io/json-schema-to-typescript-browser/
 */
export type NpmPackage = (CoreProperties & JspmDefinition & ({
...
export interface CoreProperties {
    ...
    homepage?: string;
    /**
     * The url to your project's issue tracker and
     * / or the email address to which issues should be reported.
    ...
    maintainers?: Person[];
    /**
     * The 'files' field is an array of files
     * to include in your project.
     * If you name a folder in the array,
     * then it will also include the files inside that folder.
     */
    files?: string[];
    /**
    ...
    directories?: {
         ...
         * Nothing special is done with the lib folder in any way, but it's useful meta info.
         */
        lib?: string;
        /**
    ...
    /**
     * The 'scripts' member is an object hash of script commands
     ...
     * that should be installed globally,
